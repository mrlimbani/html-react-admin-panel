                                ...
                                <form className="md-float-material form-material">
                                    ...
                                    <div className="auth-box card">
                                        <div className="card-block">
                                            ...
                                            <div className="form-group form-primary">
                                                <input type="Conform password" name="password" className="form-control" required=""
                                            ...
                                            <Link to='/main'>
                                                <div className="row m-t-30">
                                                    <div className="col-md-12">
                                                        <button type="button"
                                                            className="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Register</button>
                                                    </div>
                                                </div>
                                            </Link>
                                            <hr />
                                            <div className="row">
                                                <div className="col-md-10">
                                                    ...
                                                    <Link to='/'><p className="text-inverse text-left"><a href="../index.html"><b className="f-w-600">Back
                                                        to Login page</b></a></p></Link>
                                                </div>
